...
# Generated on: 2025-11-01 12:17:15 UTC

pkgname=windsurf-next
pkgver=1.12.140_next.5d513d45e5
pkgrel=1
...
_pkgfilename="windsurf-next_1.12.140_next.5d513d45e5_linux-x64"

source=(
    # Download the main binary, renaming it using :: syntax
    "$_pkgfilename::https://windsurf-stable.codeiumdata.com/linux-x64/next/5d513d45e52d1e058153bf7e228a748c60bd1fb6/Windsurf-linux-x64-1.12.140+next.5d513d45e5.tar.gz"
    # Include the local .desktop file
    'windsurf-next.desktop'
    # Include the URL handler .desktop file
    'windsurf-next-url-handler.desktop'
)
sha256sums=('94e1123be8ad383d7344fa5567025639130131f122aba7b87475c8142afa6cfd'
